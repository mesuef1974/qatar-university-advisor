    ...
    <div style={S.container}>
      ...
      <div style={S.content}>
        ...
        <div style={S.section}>
          ...
          <p style={S.p}>
            <strong>المستشار الجامعي القطري</strong> هو بوت إرشادي أكاديمي ذكي مقدَّم من <strong>شركة أذكياء للبرمجيات</strong>، يخدم الطلاب في دولة قطر عبر <strong>WhatsApp</strong> وموقع إلكتروني. تشمل الخدمة:
          </p>
          <ul style={S.ul}>
        ...
        <div style={S.section}>
          ...
          <p style={S.p}>
            في أقصى حدود ما يجيزه القانون القطري، <strong>لا تتحمل شركة أذكياء للبرمجيات</strong> أي مسؤولية عن:
          </p>
          <ul style={S.ul}>
        ...
        <div style={S.section}>
          ...
          <p style={S.p}>
            جميع محتويات المستشار الجامعي القطري (الردود، قواعد البيانات، واجهة المستخدم، الخوارزميات) محمية بموجب <strong>قانون حماية حقوق الملكية الفكرية القطري رقم 7 لسنة 2002</strong>. لا يُسمح بنسخها أو إعادة توزيعها تجارياً دون إذن كتابي مسبق.
          </p>
        </div>
