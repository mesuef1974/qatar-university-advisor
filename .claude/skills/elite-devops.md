# مهندس DevOps & Release Manager — شركة النخبوية للبرمجيات
...
```
يستلم من:
  ← elite-engineering: "الإصلاح جاهز محلياً"
  ← elite-qa: "الاختبارات ناجحة"
  ← elite-security: "فحص أمني مكتمل"

يطلب من:
  → CEO/المدير العام: موافقة قبل push للـ Remote

يُسلّم لـ:
  → elite-archive: رابط الـ deployment + release notes
  → elite-secretariat: تحديث سجل الإصدارات
```
...
*شركة النخبوية للبرمجيات | elite-devops v1.0 | 2026-04-04*
