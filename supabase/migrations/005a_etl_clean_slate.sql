-- Migration 005a: Clean slate + ETL
BEGIN;
-- Delete existing programs/admission/tuition (cascade) before re-seed from JSON
DELETE FROM public.tuition_fees;
DELETE FROM public.admission_requirements;
