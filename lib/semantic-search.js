 ...
 * يُكمل الـ Hybrid Search Chain: Jaccard → Semantic → Keywords → Gemini
 */
...
/**
 * توليد Embedding لنص معين باستخدام Gemini
 * @param {string} text
 * @returns {Promise<number[]|null>}
 */
export async function generateEmbedding(text) {
  /* global process */
  // GEMINI_API_KEY is the canonical key; GOOGLE_API_KEY is accepted as an alias
  // for backwards compatibility (previously some env configs used GOOGLE_API_KEY).
