    ...
    <div style={S.container}>
      ...
      <div style={S.content}>
        ...
        <div style={S.section}>
          ...
          <p style={S.p}>
            باستخدام المستشار الجامعي القطري (سواء عبر واجهة الويب أو WhatsApp)، فإنك توافق على هذه الشروط وعلى سياسة الخصوصية المرفقة. إذا كنت قاصراً (دون 18 عاماً)، يجب الحصول على موافقة ولي الأمر.
          </p>
        </div>
        ...
        <div style={S.section}>
          ...
          <p style={S.p}>
            المستشار الجامعي القطري هو <strong>خدمة إرشادية تعليمية</strong> تُقدِّم معلومات عامة عن الجامعات والتخصصات وشروط القبول في دولة قطر.
          </p>
        ...
        <div style={S.section}>
          ...
          <p style={S.p}>
            جميع محتويات المستشار الجامعي القطري (الردود، قواعد البيانات، واجهة المستخدم، الخوارزميات) محمية بموجب{' '}
